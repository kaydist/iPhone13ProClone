...
window.onload = function()  {
  if (currentScreenSize === "mobile") {
    gsap.set(".small-phone", { x: "-50%" });
    gsap.set(".large-phone", { x: "50%" });
    gsap.set(".left-text", { x: "20%", opacity: 0 });
    gsap.set(".right-text", { x: "-30%", opacity: 0 });
  }
};
...
if (currentScreenSize !== "mobile") {
  thirdPageIn.fromTo(".small-phone", { x: "-50%" }, { x: "-25%", duration: 2 });
  thirdPageIn.fromTo(
    ".large-phone",
    { x: "50%" },
    { x: "35%", duration: 2 },
