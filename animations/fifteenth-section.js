...
const fifteenthPageHeadingRight = document.querySelectorAll(
  `.fifteenth-section-heading .large-text span:nth-of-type(2n)`
);
const fifteenthPageHeadingLeft = document.querySelectorAll(
  `.fifteenth-section-heading .large-text span:nth-of-type(2n-1)`
);
...
if (currentScreenSize !== "mobile") {
  fifteenthPage.fromTo(fifteenthPageHeadingLeft, 8, { x: 0 }, { x: 150 });
...
if (currentScreenSize !== "mobile") {
  ...
  cameraLabels.to(".camera-label-1", { opacity: 0 });
  ...
  cameraLabels.to(".camera-label-2", { opacity: 0 });
  ...
  cameraLabels.to(".camera-label-3", { opacity: 0 });
}
