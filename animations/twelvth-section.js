...
const astronutPhone = document.querySelector(
  ".twelvth-section .astronut-video .phone-casing"
);
const astronutPhoneUI = document.querySelector(
  ".twelvth-section .astronut-video .phone-interface"
);
const astronutVideo = document.querySelector(
  ".twelvth-section .astronut-video video"
);
...
document.addEventListener("DOMContentLoaded", function () {
  if (currentScreenSize !== "mobile") {
    ...
    gsap.set(".twelvth-section .astronut-video", { y: "-38%" });
  }
});
